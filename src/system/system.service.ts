...
export class SystemService {
  ...
  async getAdminSettings() {
    ...
    const UserReferralAmountSetting = systemSettings['referral-amount'];
    return {
      UserReferralAmountSettings: UserReferralAmountSetting.selection
        ? Number(UserReferralAmountSetting.selection)
        : Number(UserReferralAmountSetting.default),
    };
  }
}
